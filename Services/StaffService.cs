...
{
    /// <summary>
    /// Service xá»­ lĂ½ nghiá»‡p vá»¥ cho NhĂ¢n viĂªn lá»… tĂ¢n phĂ²ng Gym (ÄÄƒng kĂ½ Scoped trong Program.cs)
    /// </summary>
    public class StaffService : IStaffService
    {
        private static readonly List<Staff> _staffs = new()
        {
            ...
            new Staff
            {
                Id = 3,
                Username = "staff_thao",
                FullName = "Pháº¡m PhÆ°Æ¡ng Tháº£o",
